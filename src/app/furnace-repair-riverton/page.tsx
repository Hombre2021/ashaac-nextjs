...
export const metadata: Metadata = { title: "Furnace Repair in Riverton, UT", description: "Request furnace repair in Riverton from All Solutions Heating and Air Conditioning. Call or submit your service address for a callback.", alternates: { canonical: "/furnace-repair-riverton" } };
