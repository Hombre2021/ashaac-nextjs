...
export const metadata: Metadata = { title: "AC Repair in South Jordan, UT | All Solutions", description: "Request AC repair in South Jordan from All Solutions Heating and Air Conditioning. Call or submit your service address for a callback.", alternates: { canonical: "/ac-repair-south-jordan" } };
