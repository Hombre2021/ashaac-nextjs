...
export const metadata: Metadata = { title: "Furnace Repair in South Jordan, UT | All Solutions", description: "Request furnace repair in South Jordan from All Solutions Heating and Air Conditioning. Call or submit your service address for a callback.", alternates: { canonical: "/furnace-repair-south-jordan" } };
