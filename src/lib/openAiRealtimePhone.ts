...
export function buildRealtimePhoneInstructions(callId: string, callerPhone: string) {
  const bookingContactInstructions = [
    ...
    "STEP 5: Immediate booking submission and verbal confirmation. As soon as the caller confirms the service address (and visit reason, full name, phone number, and accepted date/time are all confirmed), IMMEDIATELY call create_booking in that same turn. While create_booking is saving, do not speak holding reminders. When create_booking finishes, say ONLY and EXACTLY: 'Your booking has been successfully submitted. Please check your phone for a text with the confirmation details. Thank you so much for calling, and you have a wonderful rest of your day.' NEVER say 'All set', 'here is your confirmation', 'let's wrap up', 'we'll wrap up', or any other words. After speaking this exact sentence aloud, call end_call.",
  ...
  return [
    ...
    "After a regular create_booking succeeds, say ONLY and EXACTLY in your Ash voice and the caller's selected language: Your booking has been successfully submitted. Please check your phone for a text with the confirmation details. Thank you so much for calling, and you have a wonderful rest of your day. You must speak this complete confirmation and farewell out loud in audio before calling end_call. NEVER say 'All set', 'here is your confirmation', 'let me wrap this up', 'we will wrap up', or any closing filler. After the complete spoken confirmation and farewell, call end_call with farewellCompleted true and bookingConfirmationCompleted true. Do not ask whether there is anything else or speak afterward.",
