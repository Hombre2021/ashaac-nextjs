  ...
  return (
    <section className={styles.privacySection}>
      <div className={styles.privacyText}>
        <h1 style={{ textAlign: "center", fontSize: 32, marginBottom: 32 }}>Terms and Conditions</h1>
        ...
        <ul>
          ...
          <li>Secure pets and remove obstacles</li>
          <li>Be present or have an authorized person available during service</li>
        </ul>
        <p>Missed appointments may be subject to a service call fee.</p>
        ...
        <ul>
          ...
          <li>Accepted payment methods include credit/debit cards, ACH, and digital payment platforms.</li>
          <li>Deposits may be required for equipment orders or installations.</li>
          <li>Unpaid invoices may incur late fees or collection actions.</li>
        </ul>
        <p>We do not store full credit card or bank account numbers.</p>
        <h2>7. Warranty</h2>
        ...
        <ul>
          ...
          <li>Damage caused by misuse, neglect, or unauthorized repairs</li>
          <li>Issues caused by electrical or structural problems unrelated to HVAC equipment</li>
        </ul>
